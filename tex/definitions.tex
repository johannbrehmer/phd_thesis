...
%
  \includegraphicsdummy[height=0.3 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_ftphi_fw.pdf}\,%
  \includegraphicsdummy[height=0.3 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_ftphi_fww.pdf}\,%
  \phantom{\includegraphicsdummy[height=0.3 \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  ...
  \includegraphicsdummy[height=0.36 \textwidth,clip=true,trim=1.9cm 0 0 0]{fig/information/#1_fphi2_ftphi.pdf}%
  \caption{#3}
  \label{#2}
\end{figure}
}