...
%trimming options: L B R T
  \includegraphics[height=0.225 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_fw_fb.pdf}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  \includegraphics[height=0.225 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_fbb_fb.pdf}\,%
  \includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fbb_fw.pdf}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  \includegraphics[height=0.225 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_fww_fb.pdf}\,%
  \includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}\,%
  \includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fbb.pdf}\,%
  \phantom{\includegraphics[height=0.225 \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  \includegraphics[height=0.27 \textwidth,clip=true,trim=0 0 2.48cm 0]{fig/information/#1_fphi2_fb.pdf}\,%
  \includegraphics[height=0.27 \textwidth,clip=true,trim=1.9cm 0 2.48cm 0]{fig/information/#1_fphi2_fw.pdf}\,%
  \includegraphics[height=0.27 \textwidth,clip=true,trim=1.9cm 0  2.48cm 0]{fig/information/#1_fphi2_fbb.pdf}\,%
  \includegraphics[height=0.27 \textwidth,clip=true,trim=1.9cm 0  0 0]{fig/information/#1_fphi2_fww.pdf}%
  \caption{#3}
  \label{#2}
\end{figure}
}
...
\begin{figure}
%trimming options: L B R T
  \includegraphics[height=0.3 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}\,%
  \phantom{\includegraphics[height=0.3  \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_fww_fw.pdf}}\,%
  \phantom{\includegraphics[height=0.3  \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  \includegraphics[height=0.3 \textwidth,clip=true,trim=0 1.9cm 2.48cm 0]{fig/information/#1_ft_fw.pdf}\,%
  \includegraphics[height=0.3 \textwidth,clip=true,trim=1.9cm 1.9cm 2.48cm 0]{fig/information/#1_ft_fww.pdf}\,%
  \phantom{\includegraphics[height=0.3 \textwidth,clip=true,trim=1.9cm 1.9cm 0 0]{fig/information/#1_fww_fw.pdf}}\\%
%
  \includegraphics[height=0.36 \textwidth,clip=true,trim=0 0 2.48cm 0]{fig/information/#1_fphi2_fw.pdf}\,%
  \includegraphics[height=0.36 \textwidth,clip=true,trim=1.9cm 0 2.48cm 0]{fig/information/#1_fphi2_fww.pdf}\,%
  \includegraphics[height=0.36 \textwidth,clip=true,trim=1.9cm 0 0 0]{fig/information/#1_fphi2_ft.pdf}%
  \caption{#3}
  \label{#2}
\end{figure}
}