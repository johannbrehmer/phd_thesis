...
\firstword{T}{he Higgs boson}~\cite{Higgs:1964ia, Higgs:1964pj,
  Englert:1964et} is a key pillar of the Standard Model of particle
...
particle zoo of the SM. It is a triumph for a 50-year-old model, but it
...
%
% Or might it even be the source of inflation, explaining the
...
measurements with constraints from other processes, including electroweak precision
