...
\begin{figure}
  ...
  \caption{Feynman diagrams for the most important Higgs production
    modes considered in this thesis. Left: gluon fusion. Middle: weak
    boson fusion. Right: Higgs-strahlung.}
...
\begin{align}
  ...
  &=  \frac \im 2  \tr \log \left( \partial^2 + M^2 \right) + \frac \im 2  \tr \log \left( 1 + \frac {\lambda_2} 2 \frac {1} {\partial^2 + M^2} \phi^2 \right) \,,
  % &=  \frac \im 2  \intfourk \braket {k| \log \left( \partial^2 + M^2 \right) | k} \notag \\
  % &\phantom{=} \quad + \frac \im 2  \intfourk \braket {k| \log \left( 1 + \frac {\lambda_2} 2 \frac {1} {\partial^2 + M^2} \phi^2 \right) | k} \,.
\end{align}
%
where derivatives in the denominator are defined as Green's functions.
Expanding the logarithm in the second term, we find
%
\begin{equation}
  \seff \supset \frac {\im \lambda_2} 4  \tr \frac {1} {\partial^2 + M^2} \phi^2
  - \frac {\im \lambda_2^2} 8  \tr \left( \frac {1} {\partial^2 + M^2} \phi^2 \right)^2
  + \frac {\im \lambda_2^3} {12}  \tr \left( \frac {1} {\partial^2 + M^2} \phi^2\right)^3 
  + \ord{\lambda_2^4} \,.
\end{equation}
%
...
%
\begin{align}
  \seff &\supset - \frac {\im \lambda_2^3} {12} \intfourk \braket {k| \left( \frac {1} {\partial^2 + M^2} \phi^2 \right)^3 |k} \notag \\
  &\supset - \frac {\im \lambda_2^3} {12} \intfourk \!\! \intfourp \!\! \intfourq \!\! \intfourx \!\! \intfoury \!\! \intfourz \notag \\
  &\phantom{\supset} \quad \quad
    \braket {k| \frac {1} {\partial^2 + M^2} |x} \braket{x| \phi^2 |p}
    \braket {p| \frac {1} {\partial^2 + M^2} |y} \braket{y| \phi^2 |q} 
    \braket {q| \frac {1} {\partial^2 + M^2} |z} \braket{z| \phi^2 |k} \,.
\end{align}
%
...
$\braket {x|k} = e^{-\im k x}$. Using these properties, we get
%
\begin{align}
  \seff &\supset - \frac {\im \lambda_2^3} {12} \intfourk \!\! \intfourp \!\! \intfourq \!\! \intfourx \!\! \intfoury \!\! \intfourz \notag \\
  &\phantom{\supset} \quad \quad
    \frac {1} {-k^2 + M^2} e^{\im k x}  \phi(x)^2 e^{-\im p x} 
    \frac {1} {-p^2 + M^2} e^{\im p y}  \phi(y)^2 e^{-\im q y} 
    \frac {1} {-q^2 + M^2} e^{\im q z}  \phi(z)^2 e^{-\im k z}
\end{align}
%
\comment{Help! I'm lost!}
...
\item As degrees of freedoms we use the SM fields. In particular, we
  ...
  Eq.~\eqref{eq:foundations_sm_phi}. This is the correct choice if new
  physics decouples, i.\,e.\ resides at scales $\Lambda \gg v$. We
  will discuss an alternative construction based on the physical
  scalar $h$ instead of $\phi$ as the fundamental building block in
...
For a complete list of operators, see\dots
