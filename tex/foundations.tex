...
Our final channel is \emph{Higgs pair production}, showin in
...
$V_\mu$ of mass $m_V$, and an interaction between them gouverned by a
...
todiscard $\ope{\phi L}^{(1)}$, $\ope{(3)}$, and $\ope{\phi,4}$.
...
on the dipole operators. We ignore all these
...
involving fermions of the first and second generation are
