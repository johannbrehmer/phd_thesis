...
are small. Measurements of electric diple moments put tight constrains
...
operators.\footnote{This simple argument is suitable for our rather
  ...
  all cases. In particular, the increasing precision in Higgs
...
Fig.~\ref{fig:OW_Zh_demo} we demonstrate this by comparing the
...
%
\begin{alignat}{2}
  g_{hgg} &= \frac {f_{GG} v} {\Lambda^2} \,, \quad & \quad 
...
\item operators
%
\item similarity to chiral perturbation theory, cite Astrid~\cite{HillerBlin:2016jpb} if at all possible
%
\item stress that same physics is described (with examples?), explain different counting; cite Claudius Krause's thesis~\cite{Krause:2016uhw}
\end{itemize}
...
\begin{table}
  ...
  \begin{tabularx}{\textwidth}{LLLLLL} 
    ...
    %
    Motivation & 
    experiment: \newline simplest Higgs parameterisation &
    experiment: \newline Higgs signatures expected in wide range of NP models &
    ...
    Input & 
    SM Higgs couplings &
    SM particles ($h$), \newline observables, \newline pole expansion ($1/\Lambda$) &
    SM particles ($h$), \newline symmetries, \newline counting scheme (loops) & 
    SM particles ($\phi$), \newline symmetries, \newline counting scheme (dimension) & 
    ...
    &
    &
    $\dfrac {f_{\phi,2}} {\Lambda^2}$, $\dfrac {f_{W}} {\Lambda^2}$, $\dfrac {f_{WW}} {\Lambda^2}$ & 
    depends \\
    %                                                                                                
    \bottomrule
  \end{tabularx}
  \caption[Comparison of different parameterisations of Higgs properties]{Comparison
    of different parameterisations of Higgs properties.
    The upper part focusses on the theoretical foundation, the middle part the
    phenomenology. Finally, we show the parameterisation of new physics in WBF Higgs production
