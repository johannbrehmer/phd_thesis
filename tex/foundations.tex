...
against quantum corrections.\footnote{An entirely different and
  ...
  sclar field with a vacuum expectation value that changes during the
  ...
  Higgs mass. With the right coupling structures, reheating proceeds
  in such a way that most of the energy ends up in the copy with the
  smallest negative value of $\mu^2$.}\comment{Citation needed for
  criticism of anthropic principle. Check with Joerg that formulation
  of Nnaturalness is okay.} Famous examples are supersymmetry,
composite Higgs models in which the Higgs is the pseudo-Goldstone
boson of some broken symmetry, conformal
...
to the running of the quartic coupling $\lambda$ to higher
...
this indicates that there is no pressing need for physics below the Planck
...
Higgs physics in the next section, we introduce the general EFT idea.
...
be formulated as the following question: if you assign a value to a
...
What the operators $\ope{i}$ look like might be clear in a top-down
...
propagators. A more rigorous derivation than the one in the precious
...
pieces. Higher-loop corrections play no role in this thesis and were
left out.
...
\comment{Idea for better symbol for physical equivalence?}
