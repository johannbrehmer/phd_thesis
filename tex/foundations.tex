...
``Warsaw'' basis~\cite{Grzadkowski:2010es}, there is the SILH
...
fits~\cite{Corbett:2015ksa, Butter:2016cvz}. We will begin with a
slightly redundant list of operators and then discuss which of them
can be eliminated by field redefinitions.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$CP$-even Higgs operators}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Higgs physics, following Refs.~\cite{Corbett:2012ja, Corbett_thesis}.  In
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$CP$-odd Higgs operators}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
\comment{Pick CPV operators following Warsaw paper?
...
\ref{tbl:foundations_operators_four_fermion} list \dots different
operators. After $n$ of them are removed with Eqs.~{} to {}, 59
independent operators remain~\ref{Grzadkowski:2010es}.
