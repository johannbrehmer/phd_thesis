...
regularization, the first part does not give us any higher-dimensional
...
extremly ugly. \comment{Just like the dear proof
...
\begin{equation}
  \seff[\phi] = \intfourx \left[\frac 1 2 \partial_\mu \phi \partial^\mu \phi
    ...
    + \frac {\lambda_2^3} {192 \pi^2 M^2 } \, \phi^6\right] \,.
\end{equation}
%
...
between these bases see Ref.~\cite{Falkowski:2015wza}\comment{More
  references?}. Throughout this thesis we stick to the HISZ basis. 
...
\begin{table}
  ...
  \begin{tabular}{r @{${} = {}$} l @{\hspace*{2cm}} r @{${} = {}$} l} 
    ...
    \bottomrule
  \end{tabular}
  \caption[Bosonic $CP$-even dimension-6 operators.]{Bosonic $CP$-conserving
    dimension-6 operators relevant for Higgs physics.}
  \label{tbl:foundations_operators_bosonic_CPeven}
\end{table}
...
\begin{table}
  ...
  \begin{tabular*}{\textwidth}{r @{${} = {}$} l @{\hspace{0.8cm}} r @{${} = {}$} l @{\hspace{0.8cm}} r @{${} = {}$} l} 
    ...
    \bottomrule
  \end{tabular*}
  \caption[$CP$-even dimension-6 operators affecting the Higgs-fermion couplings.]
  ...
  \label{tbl:foundations_operators_fermionic_CPeven}
\end{table}

In Table~\ref{tbl:foundations_operators_bosonic_CPeven} we list
bosonic $CP$-conserving dimension-6 operators that affect Higgs
physics.  The dimension-six operators modifying the Higgs-fermion
interactions are given in
Table~\ref{tbl:foundations_operators_fermionic_CPeven}~\cite{Corbett:2012ja,
  Corbett_thesis}.  Here we use the conventions
%
\begin{equation}
...
\end{equation}
%
Finally, in Table~\ref{tbl:foundations_operators_dipole} we
list the ``dipole operators'' made of Higgs fields, gauge bosons, and
fermions.
%
\comment{To here.}
...
\begin{table}
  ...
  {Dipole operators affecting the Higgs-gauge-fermion
    couplings. For readability, flavour indices are omitted.}
...
\begin{figure}[t]
  ...
  production]{Distribution of the $Zh$ invariant mass in the
    ...
    Table~\ref{tbl:foundations_operators_bosonic_CPeven}.}
