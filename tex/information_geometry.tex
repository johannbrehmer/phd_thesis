...
This can be easily generalised to multiple nuisance parameters. The
Fisher information matrix has the block form
%
\begin{equation}
...
\end{equation}
%
and the profiled Fisher information matrix reads~\cite{Edwards:2017mnf}
%
\begin{equation}
  I^{\text{profiled}} = I^{\text{theory}} _{ab} - (I^{\text{mix}})^T \, (I^{\text{nuisance}})^{-1} \, I^{\text{mix}} \,. 
