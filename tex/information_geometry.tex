...
information geometry~\cite{efron1975, amari1982, amari2000joho}. This
defines tools that are intrinsically designed for continuous parameter
spaces of arbitrary dimensionality, independent of basis choices, and
without the need for any discretisation of the model hypothesis.
...
with the square root of the smearing function, for instance a Gaussian
or double Gaussian with parameters fitted to ATLAS and CMS
results. Other detector effects are not included in our first studies
...
multiplicatively to vertices, as is often the case of effective field
...
different measurements and between different phase-space regions within
