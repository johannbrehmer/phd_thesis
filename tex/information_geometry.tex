...
observables.  These techniques are intuitive and all their steps are
...
space in a single compact matrix. Understood as a metric on the
...
interfere destructively with diagrams depending on the top Yukawa
coupling. Small changes to these interactions can in principle change
the total production rate and the kinematics drastically. We find that
kinematic properties of the Higgs decay products and observables
