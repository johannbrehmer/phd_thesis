...
Christoffel symbols are defined as \comment{Check!}
%
\begin{equation}
...
us with another perspective on the EFT validity issues analysed in the
previous chapter\dots
%
\comment{Write about EFT validity cuts and explain Figure~\ref{fig:information_wbf_tautau_scales}!}
