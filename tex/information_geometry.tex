...
\begin{figure}
  \centering
  \includegraphics[height=0.45 \textwidth]{figures/wbf_tautau_systematics_nuisance}
  \hspace*{0.05\textwidth}
  \includegraphics[height=0.45 \textwidth]{figures/wbf_tautau_systematics_profiled}
...
\begin{figure}
  \centering
  \includegraphics[height=0.6 \textwidth]{figures/wbf_tautau_histos_comparison_systematics}
  \caption{Fisher information for the WBF $H \to \tau \tau$ channel
...
%--------------------------------------------------------
\begin{figure}
  \includegraphics[height=0.45 \textwidth]{figures/wbf_tautau_local_distance_vs_llr}
  \hspace*{0.05\textwidth}
  \includegraphics[height=0.45 \textwidth]{figures/wbf_tautau_distance_vs_llr}
