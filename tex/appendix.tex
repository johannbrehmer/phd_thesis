...
to all models of new physics. The SM Lagrangian, invariant under a
$SU(3)_C \times SU(2)_L \times U(1)_Y$ gauge group, is given by
%
\begin{multline}
  \lgr{SM}
  =
...
$\ell$, $\nu$; and the left-handed doublets with $Q$ and $L$. The
...
\end{align}
%
The covariant derivatives are defined according to the gauge charges
and with a conventional minus sign in front of the gauge term, for
instance
%
\begin{align}
...
\end{align}
%
These expressions include the coupling constants corresponding to the
SM gauge group, $g_s$, $g$, and $g'$; the structure constants
$f^{abc}$ and $\varepsilon^{abc}$ of $SU(3)$ and $SU(2)$, as well as
the Pauli matrices $\sigma^a$ and the Gell-Mann matrices
$\lambda^a$. Finally, the scalar Higgs potential contains two real
parameters $\mu^2$ and $\lambda$, and the Yukawa couplings $y_f$ are
complex-valued matrices in flavour space.
