...
Equation~\eqref{eq:validity_singlet_decoup}, the same coupling is now
...
Equation~\eqref{eq:appendix_models_2hdm_haa} in
...
In Table~\ref{tab:validity_2hdm_benchmarks} we define four benchmark
points for the 2HDM. They are in agreement with all constraints at the
time of publication of Ref.~\cite{Brehmer:2015rna}, implemented with
...
Table~\ref{tbl:validity_2hdm_couplings_tree} shows the tree-level
...
In Table~\ref{tbl:validity_2hdm_couplings_loop} we repeat this
...
Table~\ref{tab:validity_2HDM_rates} compares total production rates at
...
Figure~\ref{fig:validity_2hdm_distributions} we illustrate the coupling
...
Figure~\ref{fig:validity_2hdm_distributions}. However, the tiny rate
...
the Higgs-photon couplings. These aspects of Higgs phenomenology are
...
gauginos, sleptons, and light-flavour squarks.  
