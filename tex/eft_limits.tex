...
production and briefly discuss some practical aspects. First, we
analyse which observables are particularly useful to characterise the
validity of the EFT approach in WBF Higgs production. We then discuss
whether the square of dimension-six operators should be included in
calculations while neglecting dimension-eight operators interfering
with the SM. Both contribute at the same order $\ord{1/\Lambda^4}$ to
the squared amplitude.  Finally, we show how the EFT validity and its
breakdown affect the limit setting procedure when the EFT is used as
an intermediate parametrisation.
...
\newparagraph
%
In addition and partly simultanously to our work, published in
...
We now focus on the example WBF Higgs production in the vector triplet
model to discuss some practical aspects. The first is the question
which observables are most sensitive to the momentum transfer in this
production mode, and therefore provide a handle on the validity
regions of the EFT. In \autoref{sec:validity_squares} we discuss the
role of squared dimension-six terms in the differential cross
section. Finally, \autoref{sec:validity_fits} illustrates how limits
on the vector triplet model can be achieved directly in the full model
or indirectly via EFT measurements, and how this is affected by the
breakdown of the EFT description. 
%
\comment{To here}
...
% \begin{figure}
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T1_mVH.pdf}%
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T1_Vpt.pdf}\\%
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T1_mVH_zoom.pdf}%
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T1_Vpt_zoom}\\%
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T4_mVH}%
%   \includegraphics[width=0.49\textwidth]{fig/validity/VH_T4_Vpt}%
...
\begin{figure}
  % \includegraphics[width=0.49\textwidth]{fig/validity/WBF_T1_q.pdf}%
  % \includegraphics[width=0.49\textwidth]{fig/validity/WBF_T4_q.pdf}\\%
  ...
  \caption{WBF distributions with (``D6$^{2}$'') and without (``D6'')
    the dimension-six squared term. The right panels show the region
...
% \begin{figure}
%   \includegraphics[width=0.49\textwidth]{fig/validity/WBF_realistic_T1_j1pt.pdf}%
%   \includegraphics[width=0.49\textwidth]{fig/validity/WBF_realistic_T1_deltaEtaJJ.pdf}%
