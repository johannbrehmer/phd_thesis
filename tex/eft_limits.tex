...
Refs.~\cite{Brehmer:2015rna, Biekotter:2016ecg}, and the results and a
large part of the presentation are identical to that in these
publications.
...
The experimental energy scale of Higgs production is bounded from
below by the Higgs mass. Selection criteria necessary to separate a
signal from the QCD backgrounds often require a higher momentum
transfer. As demonstrated in Section~\ref{sec:foundations_heft_pheno},
most of the information on operators with derivatives comes from
high-energy tails, with significant contributions up to
%
\begin{equation}
...
sense. For truly strongly coupled theories, $1 < g \lesssim 4 \pi$, new
physics scenarios up to $\Lambda \lesssim 1.4~\tev$ are relevant,
where the EFT expansion converges flawlessly. In fact, the EFT
approach to Higgs observables has largely been motivated by the desire
to describe models with strongly interacting electroweak symmetry
...
cannot be useful. Instead, the validity of the dimension-six model now
...
On the other hand, in Ref.~\cite{Corbett:2015ksa} is has been shown
that a fit of dimension-6 operators to the Higgs data at Run~I is a
...
separated from the experimental uncertainties~\cite{Cranmer:2013hia,
  fichet_moreau}.
...
Gaussian approximation~\cite{Corbett:2015ksa}, a direct analysis of
full models will be superior.
...
\textit{ii)} a scalar doublet, \textit{iii)} a coloured top-partner
...
justified. We will analyse what problems the lack of a clear hierarchy
...
details on the different models and their EFT parametrisations will be
