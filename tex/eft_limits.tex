...
% For comparison, the SILH results are
% %
% \begin{align}
%   \overline{c}_{g}
%   &= \frac{{m_W}^2}{24\,(4\pi)^2\,M^2} \,
%     \left[ \kappa_{LL} + \kappa_{RR} - \kappa_{LR}^2\right] \notag \\
%   %
%   \overline{c}_{\gamma}
%   &= \frac{{m_W}^2}{9\,(4\pi)^2\,M^2} \,
%     \left[ \kappa_{LL} + \kappa_{RR} - \kappa_{LR}^2\right] \notag \\
%   %
%   \overline{c}_{B}
%   &= -\frac{5{m_W}^2}{12\,(4\pi)^2\,M^2} \,
%     \left[\kappa_{LL} - \frac{31}{50} \kappa_{LR}^2 \right] \notag \\
%   %
%   \overline{c}_{W}
%   &= \frac{{m_W}^2}{4\,(4\pi)^2\,M^2} \,
%     \left[\kappa_{LL} - \frac{3}{10} \kappa_{LR}^2 \right] \notag \\
%     % 
%   \overline{c}_{HB}
%   &= \frac{5{m_W}^2}{12\,(4\pi)^2\,M^2} \,
%     \left[\kappa_{LL} - \frac{14}{25} \kappa_{LR}^2 \right] \notag \\
%   %
%   \overline{c}_{HW}
%   &= -\frac{{m_W}^2}{4\,(4\pi)^2\,M^2} \,
%     \left[\kappa_{LL} - \frac{2}{5} \kappa_{LR}^2 \right] \notag \\
%   %
%   \overline{c}_H
%   &= \frac{v^2}{4(4\pi)^2\,M^2}\,
%     \left[ 2\kappa_{RR}^2-\kappa_{LL}^2
...
\begin{tabular}{c c rrrr c rrr}
  ...
  \bottomrule
 \end{tabular}
 \caption[Benchmarks for the scalar top partners]{Benchmarks for the
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Total production rates and distributions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\autoref{tab:validity_triplet_benchmarks} and \autoref{tab:validity_triplet_eft}.
...
Unlike in Reference~\cite{too_long} we now define our dimension-six
Lagrangian in the HISZ basis~\cite{hisz}, to make our results
compatible with the \textsc{SFitter} Run~I legacy analysis of
Reference~\cite{legacy}. The Higgs operators are defined in
\autoref{tab:validity_operators}. Our $v$-improved matching scale is
...
in \autoref{tab:validity_benchmarks}. The benchmark point T1 features
...
\begin{table}[b!]
  ...
  \caption{Benchmark points with the Wilson coefficients in the
    triplet model, as defined in Reference~\cite{too_long}.  All masses are
    given in GeV.}
...
In \autoref{fig:validity_triplet_wbf} we show a set of kinematic distributions
...
triplet model and EFT are given in \autoref{tab:validity_triplet_rates}.  For
...
\autoref{fig:validity_triplet_vh}.  In the full model the $\xi$ propagators
...
% In \autoref{fig:validity_triplet_correlations} we again go beyond individual
