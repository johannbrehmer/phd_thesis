...
\comment{To somewhere in this subsection}
...
% Eq.\,\eqref{eq:validity_vector_decoup}.  Right: signal strength correlations
...
in \toolfont{MadGraph} to the predictions of Eq.\;\eqref{eq:validity_splittings}.
