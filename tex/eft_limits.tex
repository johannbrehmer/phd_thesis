...
model-to-model basis.  We therefore select four representative models
...
points, designed to highlight phenomenological features of the model,
...
adds a second scalar $SU(2)_L$ doublet $\phi_2$ with hypercharge
$\smash{Y_{\phi_2} = 1/2}$ to the SM Higgs sector. The combined
potential reads
%
\begin{multline}
  V(\phi_1,\phi_2) =
